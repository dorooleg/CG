...
bool ParticleSystem::InitParticleSystem(const Vector3f& Pos)
{
	...
	Particles[0].Pos = Pos;
	Particles[0].Vel = Vector3f(0.0f, 0.0002f, 0.0f);
	...
	m_pTexture = new Texture(GL_TEXTURE_2D, "../ParticleSystem/fireworks_red.jpg");
...
void ParticleSystem::UpdateParticles(int DeltaTimeMillis)
{
	...
	glVertexAttribPointer(0, 1, GL_FLOAT, GL_FALSE, sizeof(Particle), nullptr); // type
